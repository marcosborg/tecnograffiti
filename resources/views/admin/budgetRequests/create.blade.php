        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.budget-requests.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="form-group {{ $errors->has('urgency') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-control select2" name="urgency_id" id="urgency_id" required>
                                        @foreach($urgencies as $id => $entry)
                                            <option value="{{ $id }}" {{ old('urgency_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group {{ $errors->has('billing_client') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-control select2" name="billing_client_id" id="billing_client_id">
                                        @foreach($billing_clients as $id => $entry)
                                            <option value="{{ $id }}" {{ old('billing_client_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                        @endforeach
                                    </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('request') ? 'has-error' : '' }}">
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="request" id="request" value="1" {{ old('request', 0) == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('request_date') ? 'has-error' : '' }}">
                                                    ...
                                                    <input class="form-control date" type="text" name="request_date" id="request_date" value="{{ old('request_date') }}">
                                                ...
                                                <div class="form-group {{ $errors->has('reception_mode') ? 'has-error' : '' }}">
                                                    ...
                                                    <select class="form-control select2" name="reception_mode_id" id="reception_mode_id">
                                                        @foreach($reception_modes as $id => $entry)
                                                            <option value="{{ $id }}" {{ old('reception_mode_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('sent_date') ? 'has-error' : '' }}">
                                                    ...
                                                    <input class="form-control date" type="text" name="sent_date" id="sent_date" value="{{ old('sent_date') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('adjudicated') ? 'has-error' : '' }}">
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="adjudicated" id="adjudicated" value="1" {{ old('adjudicated', 0) == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('adjudicated_date') ? 'has-error' : '' }}">
                                                    ...
                                                    <input class="form-control date" type="text" name="adjudicated_date" id="adjudicated_date" value="{{ old('adjudicated_date') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('concluded') ? 'has-error' : '' }}">
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="concluded" id="concluded" value="1" {{ old('concluded', 0) == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('concluded_date') ? 'has-error' : '' }}">
                                                    ...
                                                    <input class="form-control date" type="text" name="concluded_date" id="concluded_date" value="{{ old('concluded_date') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('invoice') ? 'has-error' : '' }}">
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="invoice" id="invoice" value="1" {{ old('invoice', 0) == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('invoice_date') ? 'has-error' : '' }}">
                                                    ...
                                                    <input class="form-control date" type="text" name="invoice_date" id="invoice_date" value="{{ old('invoice_date') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('survey') ? 'has-error' : '' }}">
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="survey" id="survey" value="1" {{ old('survey', 0) == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('survey_date') ? 'has-error' : '' }}">
                                                    ...
                                                    <input class="form-control date" type="text" name="survey_date" id="survey_date" value="{{ old('survey_date') }}">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group {{ $errors->has('work_data_1') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_1" id="work_data_1" value="1" {{ old('work_data_1', 0) == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group {{ $errors->has('work_data_2') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_2" id="work_data_2" value="1" {{ old('work_data_2', 0) == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group {{ $errors->has('work_data_3') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_3" id="work_data_3" value="1" {{ old('work_data_3', 0) == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group {{ $errors->has('work_data_4') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_4" id="work_data_4" value="1" {{ old('work_data_4', 0) == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group {{ $errors->has('work_data_5') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_5" id="work_data_5" value="1" {{ old('work_data_5', 0) == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group {{ $errors->has('work_data_6') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_6" id="work_data_6" value="1" {{ old('work_data_6', 0) == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group {{ $errors->has('work_data_7') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_7" id="work_data_7" value="1" {{ old('work_data_7', 0) == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group {{ $errors->has('work_data_8') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_8" id="work_data_8" value="1" {{ old('work_data_8', 0) == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group {{ $errors->has('work_data_9') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_9" id="work_data_9" value="1" {{ old('work_data_9', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('location_info') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="text" name="location_info" id="location_info" value="{{ old('location_info', '') }}">
                                ...
                                <div class="form-group {{ $errors->has('info') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-control select2" name="info_id" id="info_id">
                                        @foreach($infos as $id => $entry)
                                            <option value="{{ $id }}" {{ old('info_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                        @endforeach
                                    </select>
                                    @if($errors->has('info'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('obs') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="text" name="obs" id="obs" value="{{ old('obs', '') }}">
                                    @if($errors->has('obs'))
