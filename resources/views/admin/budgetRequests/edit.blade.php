        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.budget-requests.update", [$budgetRequest->id]) }}"
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('reference') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="text" name="reference" id="reference"
                                        value="{{ old('reference', $budgetRequest->reference) }}" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('urgency') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-control select2" name="urgency_id" id="urgency_id" required>
                                        ...
                                        <option value="{{ $id }}" {{ (old('urgency_id') ? old('urgency_id') :
                                            $budgetRequest->urgency->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('client') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-control select2" name="client_id" id="client_id" required>
                                        ...
                                        <option value="{{ $id }}" {{ (old('client_id') ? old('client_id') :
                                            $budgetRequest->client->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('billing_client') ? 'has-error' : '' }}">
                                    <label for="billing_client_id">{{ trans('cruds.budgetRequest.fields.billing_client')
                                        }}</label>
                                    <select class="form-control select2" name="billing_client_id"
                                        id="billing_client_id">
                                        @foreach($billing_clients as $id => $entry)
                                        <option value="{{ $id }}" {{ (old('billing_client_id') ?
                                            old('billing_client_id') : $budgetRequest->billing_client->id ?? '') == $id
                                    ...
                                    <span class="help-block">{{
                                        trans('cruds.budgetRequest.fields.billing_client_helper') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="row">
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="request" id="request" value="1" {{
                                                            $budgetRequest->request || old('request', 0) === 1 ?
                                                        'checked' : '' }}>
                                                    ...
                                                    @endif
                                                    <span class="help-block">{{
                                                        trans('cruds.budgetRequest.fields.request_helper') }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div
                                                    ...
                                                    <label for="request_date">{{
                                                        trans('cruds.budgetRequest.fields.request_date') }}</label>
                                                    <input class="form-control date" type="text" name="request_date"
                                                        id="request_date"
                                                        value="{{ old('request_date', $budgetRequest->request_date) }}">
                                                    @if($errors->has('request_date'))
                                                    <span class="help-block" role="alert">{{
                                                        $errors->first('request_date') }}</span>
                                                    @endif
                                                    <span class="help-block">{{
                                            ...
                                            <div class="col-md-4">
                                                <div
                                                    class="form-group {{ $errors->has('reception_mode') ? 'has-error' : '' }}">
                                                    <label for="reception_mode_id">{{
                                                        trans('cruds.budgetRequest.fields.reception_mode') }}</label>
                                                    <select class="form-control select2" name="reception_mode_id"
                                                        id="reception_mode_id">
                                                        @foreach($reception_modes as $id => $entry)
                                                        <option value="{{ $id }}" {{ (old('reception_mode_id') ?
                                                            old('reception_mode_id') : $budgetRequest->
                                                            reception_mode->id ?? '') == $id ? 'selected' : '' }}>{{
                                                            $entry }}</option>
                                                        @endforeach
                                                    </select>
                                                    @if($errors->has('reception_mode'))
                                                    <span class="help-block" role="alert">{{
                                                        $errors->first('reception_mode') }}</span>
                                                    @endif
                                                    <span class="help-block">{{
                                                        trans('cruds.budgetRequest.fields.reception_mode_helper')
                                                        }}</span>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group {{ $errors->has('sent') ? 'has-error' : '' }}">
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="sent" id="sent" value="1" {{
                                                            $budgetRequest->sent || old('sent', 0) === 1 ? 'checked' :
                                                        '' }}>
                                                        <label for="sent" style="font-weight: 400">{{
                                                            trans('cruds.budgetRequest.fields.sent') }}</label>
                                                    </div>
                                                    @if($errors->has('sent'))
                                                    ...
                                                    @endif
                                                    <span class="help-block">{{
                                                        trans('cruds.budgetRequest.fields.sent_helper') }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div
                                                    ...
                                                    <input class="form-control date" type="text" name="sent_date"
                                                        id="sent_date"
                                                        value="{{ old('sent_date', $budgetRequest->sent_date) }}">
                                                    @if($errors->has('sent_date'))
                                                    <span class="help-block" role="alert">{{ $errors->first('sent_date')
                                                        }}</span>
                                                    @endif
                                                    <span class="help-block">{{
                                                        trans('cruds.budgetRequest.fields.sent_date_helper') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="adjudicated" id="adjudicated"
                                                            value="1" {{ $budgetRequest->adjudicated ||
                                                        old('adjudicated', 0) === 1 ? 'checked' : '' }}>
                                                    ...
                                                    @endif
                                                    <span class="help-block">{{
                                                        trans('cruds.budgetRequest.fields.adjudicated_helper') }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div
                                                    ...
                                                    <label for="adjudicated_date">{{
                                                        trans('cruds.budgetRequest.fields.adjudicated_date') }}</label>
                                                    <input class="form-control date" type="text" name="adjudicated_date"
                                                        id="adjudicated_date"
                                                        value="{{ old('adjudicated_date', $budgetRequest->adjudicated_date) }}">
                                                    @if($errors->has('adjudicated_date'))
                                                    <span class="help-block" role="alert">{{
                                                        $errors->first('adjudicated_date') }}</span>
                                                    @endif
                                                    <span class="help-block">{{
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="concluded" id="concluded" value="1"
                                                            {{ $budgetRequest->concluded || old('concluded', 0) === 1 ?
                                                        'checked' : '' }}>
                                                    ...
                                                    @endif
                                                    <span class="help-block">{{
                                                        trans('cruds.budgetRequest.fields.concluded_helper') }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div
                                                    ...
                                                    <label for="concluded_date">{{
                                                        trans('cruds.budgetRequest.fields.concluded_date') }}</label>
                                                    <input class="form-control date" type="text" name="concluded_date"
                                                        id="concluded_date"
                                                        value="{{ old('concluded_date', $budgetRequest->concluded_date) }}">
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="invoice" id="invoice" value="1" {{
                                                            $budgetRequest->invoice || old('invoice', 0) === 1 ?
                                                        'checked' : '' }}>
                                                    ...
                                                    @endif
                                                    <span class="help-block">{{
                                                        trans('cruds.budgetRequest.fields.invoice_helper') }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div
                                                    ...
                                                    <label for="invoice_date">{{
                                                        trans('cruds.budgetRequest.fields.invoice_date') }}</label>
                                                    <input class="form-control date" type="text" name="invoice_date"
                                                        id="invoice_date"
                                                        value="{{ old('invoice_date', $budgetRequest->invoice_date) }}">
                                                ...
                                                <div class="form-group {{ $errors->has('survey') ? 'has-error' : '' }}">
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="survey" id="survey" value="1" {{
                                                            $budgetRequest->survey || old('survey', 0) === 1 ? 'checked'
                                                        : '' }}>
                                                    ...
                                                    @endif
                                                    <span class="help-block">{{
                                                        trans('cruds.budgetRequest.fields.survey_helper') }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div
                                                    ...
                                                    <label for="survey_date">{{
                                                        trans('cruds.budgetRequest.fields.survey_date') }}</label>
                                                    <input class="form-control date" type="text" name="survey_date"
                                                        id="survey_date"
                                                        value="{{ old('survey_date', $budgetRequest->survey_date) }}">
                                                    @if($errors->has('survey_date'))
                                                    <span class="help-block" role="alert">{{
                                                        $errors->first('survey_date') }}</span>
                                                    @endif
                                                    <span class="help-block">{{
                                                        trans('cruds.budgetRequest.fields.survey_date_helper') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group {{ $errors->has('work_data_1') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_1" id="work_data_1" value="1" {{
                                                    $budgetRequest->work_data_1 || old('work_data_1', 0) === 1 ?
                                                'checked' : '' }}>
                                            ...
                                            @endif
                                            <span class="help-block">{{
                                                trans('cruds.budgetRequest.fields.work_data_1_helper') }}</span>
                                        </div>
                                        <div class="form-group {{ $errors->has('work_data_2') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_2" id="work_data_2" value="1" {{
                                                    $budgetRequest->work_data_2 || old('work_data_2', 0) === 1 ?
                                                'checked' : '' }}>
                                            ...
                                            @endif
                                            <span class="help-block">{{
                                                trans('cruds.budgetRequest.fields.work_data_2_helper') }}</span>
                                        </div>
                                        <div class="form-group {{ $errors->has('work_data_3') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_3" id="work_data_3" value="1" {{
                                                    $budgetRequest->work_data_3 || old('work_data_3', 0) === 1 ?
                                                'checked' : '' }}>
                                            ...
                                            @endif
                                            <span class="help-block">{{
                                                trans('cruds.budgetRequest.fields.work_data_3_helper') }}</span>
                                        </div>
                                        <div class="form-group {{ $errors->has('work_data_4') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_4" id="work_data_4" value="1" {{
                                                    $budgetRequest->work_data_4 || old('work_data_4', 0) === 1 ?
                                                'checked' : '' }}>
                                            ...
                                            @endif
                                            <span class="help-block">{{
                                                trans('cruds.budgetRequest.fields.work_data_4_helper') }}</span>
                                        </div>
                                        <div class="form-group {{ $errors->has('work_data_5') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_5" id="work_data_5" value="1" {{
                                                    $budgetRequest->work_data_5 || old('work_data_5', 0) === 1 ?
                                                'checked' : '' }}>
                                            ...
                                            @endif
                                            <span class="help-block">{{
                                                trans('cruds.budgetRequest.fields.work_data_5_helper') }}</span>
                                        </div>
                                        <div class="form-group {{ $errors->has('work_data_6') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_6" id="work_data_6" value="1" {{
                                                    $budgetRequest->work_data_6 || old('work_data_6', 0) === 1 ?
                                                'checked' : '' }}>
                                            ...
                                            @endif
                                            <span class="help-block">{{
                                                trans('cruds.budgetRequest.fields.work_data_6_helper') }}</span>
                                        </div>
                                        <div class="form-group {{ $errors->has('work_data_7') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_7" id="work_data_7" value="1" {{
                                                    $budgetRequest->work_data_7 || old('work_data_7', 0) === 1 ?
                                                'checked' : '' }}>
                                            ...
                                            @endif
                                            <span class="help-block">{{
                                                trans('cruds.budgetRequest.fields.work_data_7_helper') }}</span>
                                        </div>
                                        <div class="form-group {{ $errors->has('work_data_8') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_8" id="work_data_8" value="1" {{
                                                    $budgetRequest->work_data_8 || old('work_data_8', 0) === 1 ?
                                                'checked' : '' }}>
                                            ...
                                            @endif
                                            <span class="help-block">{{
                                                trans('cruds.budgetRequest.fields.work_data_8_helper') }}</span>
                                        </div>
                                        <div class="form-group {{ $errors->has('work_data_9') ? 'has-error' : '' }}">
                                            <div>
                                                <input type="hidden" name="work_data_9" value="0">
                                                <input type="checkbox" name="work_data_9" id="work_data_9" value="1" {{
                                                    $budgetRequest->work_data_9 || old('work_data_9', 0) === 1 ?
                                                'checked' : '' }}>
                                                <label for="work_data_9" style="font-weight: 400">{{
                                                    trans('cruds.budgetRequest.fields.work_data_9') }}</label>
                                            </div>
                                            @if($errors->has('work_data_9'))
                                            <span class="help-block" role="alert">{{ $errors->first('work_data_9')
                                                }}</span>
                                            @endif
                                            <span class="help-block">{{
                                                trans('cruds.budgetRequest.fields.work_data_9_helper') }}</span>
                                        </div>
                                        <div class="form-group {{ $errors->has('surface_types') ? 'has-error' : '' }}">
                                            <label for="surface_types">{{
                                                trans('cruds.budgetRequest.fields.surface_type') }}</label>
                                            ...
                                            <select class="form-control select2" name="surface_types[]"
                                                id="surface_types" multiple>
                                                @foreach($surface_types as $id => $surface_type)
                                                <option value="{{ $id }}" {{ (in_array($id, old('surface_types', [])) ||
                                                    $budgetRequest->surface_types->contains($id)) ? 'selected' : ''
                                                    }}>{{ $surface_type }}</option>
                                                @endforeach
                                            </select>
                                            @if($errors->has('surface_types'))
                                            <span class="help-block" role="alert">{{ $errors->first('surface_types')
                                                }}</span>
                                            @endif
                                            <span class="help-block">{{
                                                trans('cruds.budgetRequest.fields.surface_type_helper') }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="text" name="address" id="address"
                                        value="{{ old('address', $budgetRequest->address) }}">
                                    @if($errors->has('address'))
                                    <span class="help-block" role="alert">{{ $errors->first('address') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.budgetRequest.fields.address_helper')
                                        }}</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('location_info') ? 'has-error' : '' }}">
                                    <label for="location_info">{{ trans('cruds.budgetRequest.fields.location_info')
                                        }}</label>
                                    <input class="form-control" type="text" name="location_info" id="location_info"
                                        value="{{ old('location_info', $budgetRequest->location_info) }}">
                                    @if($errors->has('location_info'))
                                    <span class="help-block" role="alert">{{ $errors->first('location_info') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.budgetRequest.fields.location_info_helper')
                                        }}</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('info') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-control select2" name="info_id" id="info_id">
                                        ...
                                        <option value="{{ $id }}" {{ (old('info_id') ? old('info_id') : $budgetRequest->
                                            info->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                        @endforeach
                                    </select>
                                    @if($errors->has('info'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('obs') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="text" name="obs" id="obs"
                                        value="{{ old('obs', $budgetRequest->obs) }}">
                                    @if($errors->has('obs'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('duration_hours') ? 'has-error' : '' }}">
                                    <label for="duration_hours">{{ trans('cruds.budgetRequest.fields.duration_hours')
                                        }}</label>
                                    <input class="form-control" type="number" name="duration_hours" id="duration_hours"
                                        value="{{ old('duration_hours', $budgetRequest->duration_hours) }}" step="1">
                                    @if($errors->has('duration_hours'))
                                    <span class="help-block" role="alert">{{ $errors->first('duration_hours') }}</span>
                                    @endif
                                    <span class="help-block">{{
                                        trans('cruds.budgetRequest.fields.duration_hours_helper') }}</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('duration_days') ? 'has-error' : '' }}">
                                    <label for="duration_days">{{ trans('cruds.budgetRequest.fields.duration_days')
                                        }}</label>
                                    <input class="form-control" type="number" name="duration_days" id="duration_days"
                                        value="{{ old('duration_days', $budgetRequest->duration_days) }}" step="1">
                                    @if($errors->has('duration_days'))
                                    <span class="help-block" role="alert">{{ $errors->first('duration_days') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.budgetRequest.fields.duration_days_helper')
                                        }}</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('duration_saturdays') ? 'has-error' : '' }}">
                                    <label for="duration_saturdays">{{
                                        trans('cruds.budgetRequest.fields.duration_saturdays') }}</label>
                                    <input class="form-control" type="number" name="duration_saturdays"
                                        id="duration_saturdays"
                                        value="{{ old('duration_saturdays', $budgetRequest->duration_saturdays) }}"
                                        step="1">
                                    @if($errors->has('duration_saturdays'))
                                    <span class="help-block" role="alert">{{ $errors->first('duration_saturdays')
                                        }}</span>
                                    @endif
                                    <span class="help-block">{{
                                        trans('cruds.budgetRequest.fields.duration_saturdays_helper') }}</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('duration_nights') ? 'has-error' : '' }}">
                                    <label for="duration_nights">{{ trans('cruds.budgetRequest.fields.duration_nights')
                                        }}</label>
                                    <input class="form-control" type="number" name="duration_nights"
                                        id="duration_nights"
                                        value="{{ old('duration_nights', $budgetRequest->duration_nights) }}" step="1">
                                    @if($errors->has('duration_nights'))
                                    <span class="help-block" role="alert">{{ $errors->first('duration_nights') }}</span>
                                    @endif
                                    <span class="help-block">{{
                                        trans('cruds.budgetRequest.fields.duration_nights_helper') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group {{ $errors->has('other_information') ? 'has-error' : '' }}">
                            <label for="other_information">{{ trans('cruds.budgetRequest.fields.other_information')
                                }}</label>
                            <textarea class="form-control ckeditor" name="other_information"
                                id="other_information">{!! old('other_information', $budgetRequest->other_information) !!}</textarea>
                            @if($errors->has('other_information'))
                            <span class="help-block" role="alert">{{ $errors->first('other_information') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.budgetRequest.fields.other_information_helper')
                                }}</span>
                        </div>
