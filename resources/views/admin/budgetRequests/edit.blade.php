                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('request_mode') ? 'has-error' : '' }}">
                                                    <label for="request_mode">{{ trans('cruds.budgetRequest.fields.request_mode') }}</label>
                                                    <input class="form-control" type="text" name="request_mode" id="request_mode" value="{{ old('request_mode', $budgetRequest->request_mode) }}">
                                                    @if($errors->has('request_mode'))
                                                        <span class="help-block" role="alert">{{ $errors->first('request_mode') }}</span>
                                                    @endif
                                                    <span class="help-block">{{ trans('cruds.budgetRequest.fields.request_mode_helper') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('sent_mode') ? 'has-error' : '' }}">
                                                    <label for="sent_mode">{{ trans('cruds.budgetRequest.fields.sent_mode') }}</label>
                                                    <input class="form-control" type="text" name="sent_mode" id="sent_mode" value="{{ old('sent_mode', $budgetRequest->sent_mode) }}">
                                                    @if($errors->has('sent_mode'))
                                                        <span class="help-block" role="alert">{{ $errors->first('sent_mode') }}</span>
                                                    @endif
                                                    <span class="help-block">{{ trans('cruds.budgetRequest.fields.sent_mode_helper') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('deadline') ? 'has-error' : '' }}">
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="deadline" id="deadline" value="1" {{ $budgetRequest->deadline || old('deadline', 0) === 1 ? 'checked' : '' }}>
                                                        <label for="deadline" style="font-weight: 400">{{ trans('cruds.budgetRequest.fields.deadline') }}</label>
                                                    </div>
                                                    @if($errors->has('deadline'))
                                                        <span class="help-block" role="alert">{{ $errors->first('deadline') }}</span>
                                                    @endif
                                                    <span class="help-block">{{ trans('cruds.budgetRequest.fields.deadline_helper') }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('deadline_date') ? 'has-error' : '' }}">
                                                    <label for="deadline_date">{{ trans('cruds.budgetRequest.fields.deadline_date') }}</label>
                                                    <input class="form-control date" type="text" name="deadline_date" id="deadline_date" value="{{ old('deadline_date', $budgetRequest->deadline_date) }}">
                                                    @if($errors->has('deadline_date'))
                                                        <span class="help-block" role="alert">{{ $errors->first('deadline_date') }}</span>
                                                    @endif
                                                    <span class="help-block">{{ trans('cruds.budgetRequest.fields.deadline_date_helper') }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('deadline_mode') ? 'has-error' : '' }}">
                                                    <label for="deadline_mode">{{ trans('cruds.budgetRequest.fields.deadline_mode') }}</label>
                                                    <input class="form-control" type="text" name="deadline_mode" id="deadline_mode" value="{{ old('deadline_mode', $budgetRequest->deadline_mode) }}">
                                                    @if($errors->has('deadline_mode'))
                                                        <span class="help-block" role="alert">{{ $errors->first('deadline_mode') }}</span>
                                                    @endif
                                                    <span class="help-block">{{ trans('cruds.budgetRequest.fields.deadline_mode_helper') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('adjudicated_mode') ? 'has-error' : '' }}">
                                                    <label for="adjudicated_mode">{{ trans('cruds.budgetRequest.fields.adjudicated_mode') }}</label>
                                                    <input class="form-control" type="text" name="adjudicated_mode" id="adjudicated_mode" value="{{ old('adjudicated_mode', $budgetRequest->adjudicated_mode) }}">
                                                    @if($errors->has('adjudicated_mode'))
                                                        <span class="help-block" role="alert">{{ $errors->first('adjudicated_mode') }}</span>
                                                    @endif
                                                    <span class="help-block">{{ trans('cruds.budgetRequest.fields.adjudicated_mode_helper') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('concluded_mode') ? 'has-error' : '' }}">
                                                    <label for="concluded_mode">{{ trans('cruds.budgetRequest.fields.concluded_mode') }}</label>
                                                    <input class="form-control" type="text" name="concluded_mode" id="concluded_mode" value="{{ old('concluded_mode', $budgetRequest->concluded_mode) }}">
                                                    @if($errors->has('concluded_mode'))
                                                        <span class="help-block" role="alert">{{ $errors->first('concluded_mode') }}</span>
                                                    @endif
                                                    <span class="help-block">{{ trans('cruds.budgetRequest.fields.concluded_mode_helper') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('invoice_mode') ? 'has-error' : '' }}">
                                                    <label for="invoice_mode">{{ trans('cruds.budgetRequest.fields.invoice_mode') }}</label>
                                                    <input class="form-control" type="text" name="invoice_mode" id="invoice_mode" value="{{ old('invoice_mode', $budgetRequest->invoice_mode) }}">
                                                    @if($errors->has('invoice_mode'))
                                                        <span class="help-block" role="alert">{{ $errors->first('invoice_mode') }}</span>
                                                    @endif
                                                    <span class="help-block">{{ trans('cruds.budgetRequest.fields.invoice_mode_helper') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('survey_mode') ? 'has-error' : '' }}">
                                                    <label for="survey_mode">{{ trans('cruds.budgetRequest.fields.survey_mode') }}</label>
                                                    <input class="form-control" type="text" name="survey_mode" id="survey_mode" value="{{ old('survey_mode', $budgetRequest->survey_mode) }}">
                                                    @if($errors->has('survey_mode'))
                                                        <span class="help-block" role="alert">{{ $errors->first('survey_mode') }}</span>
                                                    @endif
                                                    <span class="help-block">{{ trans('cruds.budgetRequest.fields.survey_mode_helper') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group {{ $errors->has('work_data_1_1') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="work_data_1_1" id="work_data_1_1" value="1" {{ $budgetRequest->work_data_1_1 || old('work_data_1_1', 0) === 1 ? 'checked' : '' }}>
                                                <label for="work_data_1_1" style="font-weight: 400">{{ trans('cruds.budgetRequest.fields.work_data_1_1') }}</label>
                                            </div>
                                            @if($errors->has('work_data_1_1'))
                                                <span class="help-block" role="alert">{{ $errors->first('work_data_1_1') }}</span>
                                            @endif
                                            <span class="help-block">{{ trans('cruds.budgetRequest.fields.work_data_1_1_helper') }}</span>
                                        </div>
                                        <div class="form-group {{ $errors->has('work_data_1_2') ? 'has-error' : '' }}">
                                            <div>
                                                <input type="hidden" name="work_data_1_2" value="0">
                                                <input type="checkbox" name="work_data_1_2" id="work_data_1_2" value="1" {{ $budgetRequest->work_data_1_2 || old('work_data_1_2', 0) === 1 ? 'checked' : '' }}>
                                                <label for="work_data_1_2" style="font-weight: 400">{{ trans('cruds.budgetRequest.fields.work_data_1_2') }}</label>
                                            </div>
                                            @if($errors->has('work_data_1_2'))
                                                <span class="help-block" role="alert">{{ $errors->first('work_data_1_2') }}</span>
                                            @endif
                                            <span class="help-block">{{ trans('cruds.budgetRequest.fields.work_data_1_2_helper') }}</span>
                                        </div>
