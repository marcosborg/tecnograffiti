                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contacts.update", [$contact->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $contact->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $contact->address) }}">
                        ...
                        <div class="form-group {{ $errors->has('subject') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="subject" id="subject" value="{{ old('subject', $contact->subject) }}">
