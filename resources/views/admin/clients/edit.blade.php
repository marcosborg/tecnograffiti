                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.clients.update", [$client->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('client_type') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="client_type_id" id="client_type_id" required>
                                @foreach($client_types as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('client_type_id') ? old('client_type_id') : $client->client_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('shipping_address') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="email" name="shipping_address" id="shipping_address" value="{{ old('shipping_address', $client->shipping_address) }}">
                        ...
                        <div class="form-group {{ $errors->has('department') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="department" id="department" value="{{ old('department', $client->department) }}">
                        ...
                        <div class="form-group {{ $errors->has('phone_1') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone_1" id="phone_1" value="{{ old('phone_1', $client->phone_1) }}">
                        ...
                        <div class="form-group {{ $errors->has('phone_2') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone_2" id="phone_2" value="{{ old('phone_2', $client->phone_2) }}">
                        ...
                        <div class="form-group {{ $errors->has('contact') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact" id="contact" value="{{ old('contact', $client->contact) }}">
                        ...
                        <div class="form-group {{ $errors->has('celphone') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="celphone" id="celphone" value="{{ old('celphone', $client->celphone) }}">
